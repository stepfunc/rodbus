...
int main()
{
    ...
    self_signed_tls_config.certificate_mode = RODBUS_CERTIFICATE_MODE_SELF_SIGNED;
    ...
    err = rodbus_client_channel_create_tls(runtime, "127.0.0.1:802", 100, rodbus_retry_strategy_init(), tls_config, decode_level, &channel);
    if (err) {
