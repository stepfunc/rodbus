...
```c
{{#include ../ffi/bindings/c/client_example.c:runtime_create}}
```
...
```cpp
{{#include ../ffi/bindings/c/client_example.cpp:runtime_create}}
```
...
```java
{{#include ../ffi/bindings/java/examples/src/main/java/io/stepfunc/rodbus/examples/ClientExample.java:runtime_init}}
```
</TabItem>
<TabItem value="C#">

```csharp
{{#include ../ffi/bindings/dotnet/examples/client/Program.cs:runtime_init}}
```
...
to shutdown is synchronous. When it completes you are assured there are no longer any tasks running and all of the Tokio
...
```c
{{#include ../ffi/bindings/c/client_example.c:runtime_destroy}}
```
...
:::note
Runtime shutdown is automatically called in the `ClientChannel` destructor.
:::
...
```java
{{#include ../ffi/bindings/java/examples/src/main/java/io/stepfunc/rodbus/examples/ClientExample.java:runtime_shutdown}}
```
...
```csharp
{{#include ../ffi/bindings/dotnet/examples/client/Program.cs:runtime_shutdown}}
```
